...
CKEDITOR.dialog.add( 'radio', function( editor ) {
	return {
		...
		contents: [
         ...
         { id: 'note',
           type: 'html',
           html: '<i>Note: Use the same "Name" for all mutually-exclusive radio buttons in a group.</i>'
           },
				{
				id: 'value',
				type: 'text',
				...
				commit: function( data ) {
					...
					if ( !( CKEDITOR.env.ie || CKEDITOR.env.opera ) ) {
						...
						if ( isElementChecked != isChecked ) {
							...
							element.copyAttributes( replace, { type: 1, checked: 1, class: 1 } );
						...
						{ type:    'checkbox', 
						  ...
						  setup: function( element ) {
								...
								this.setValue( String(v).match(/required/i) ? "checked" : "" );
								},
